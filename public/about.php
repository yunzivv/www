            ...
            <article class="about-eng" data-reveal>
                ...
                <div class="about-eng__list">
                    <div class="about-eng__item">
                        ...
                        <p class="mv-muted">고객의 타겟 하드웨어를 위한 Linux BSP 개발 및 검증, 사후 유지보수 서비스(버그픽스, 보안패치)</p>
                    </div>

                    <div class="about-eng__item">
                        <div class="about-eng__t">운영체제 Migration 서비스</div>
                        <p class="mv-muted">Vxworks to Linux, Windows to Linux, RHEL to CentOS 등 기존 운영체제에 대한 Linux Migration 서비스 제공</p>
                    </div>

                    <div class="about-eng__item">
                        <div class="about-eng__t">Linux 시스템 성능 개선</div>
                        <p class="mv-muted">부팅타임 최소화, 실시간 성능 보장, 네트워크 대역폭 최대화 및 지연 최소화</p>
                    </div>

                    <div class="about-eng__item">
                        <div class="about-eng__t">시스템 보안성 강화 기능</div>
                        <p class="mv-muted">Secure boot, TPM, TEE/Trustzone, Address Space, Layout Randomization</p>
                    </div>
                </div>
            </article>
        </div>
